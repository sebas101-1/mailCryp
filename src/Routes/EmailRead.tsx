      ...
      <div className='bg-white strong-shadow transition shadow-2xl h-[90vh] overflow-auto w-[90vw] '>
        ...
        <div className='mt-2'>
          <div className='flex mb-10'>
            ...
            <svg fill={starred? 'yellow' : 'none'} onClick={() => {setStarred(!starred)}} className='md:hover:cursor-pointer h-[1.5rem] justify-end transition-all md:hover:scale-150 ml-4 md:ml-8' viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <Link to={'/home'}>
              <svg onMouseEnter={() => {setTrashHovered(true)}} onMouseLeave={() => {setTrashHovered(false)}} className='h-[1.5rem] justify-end transition-all hover:scale-150 ml-4 md:ml-8' viewBox="0 0 24 24" fill={trashHovered? 'red':'none'} xmlns="http://www.w3.org/2000/svg">
            ...
            <svg onClick={() => setReply(!reply)} className='md:hover:cursor-pointer h-[1.5rem] justify-end transition-all md:hover:scale-150 ml-4 md:ml-8' viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
