      ...
      <div className='bg-gray-200 transition shadow-2xl h-[90vh] overflow-auto w-[90vw] '>
        ...
        <div className='mt-2'>
          <div className='flex mb-10'>
            ...
            <svg fill={starred? 'yellow' : 'none'} onClick={() => {setStarred(!starred)}} className='h-[1.5rem] justify-end transition-all hover:scale-150 ml-8' viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg onClick={() => setReply(!reply)} className='h-[1.5rem] justify-end transition-all hover:scale-150 ml-8' viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
